...
<div class="page-container">
	<div class="text-c"> 
		<form action="servlet/HouseServlet?method=findHouseByXXX" method="post">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="90">房屋地址</th>
				<th width="90">户型</th>
				<th width="90">面积<span class="c-red">（M²）</span></th>
				<th width="90">价格<span class="c-red">（/M²）</span></th>
				<th width="90">总价<span class="c-red">（￥）</th>
