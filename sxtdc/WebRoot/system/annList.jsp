		...
		<tbody>
			<c:forEach items="${annList }" var="ann">
				<tr class="text-c">
					...
					<a title="编辑" href="servlet/AnnouncementServlet?method=findByIdAnn&annid=${ann.annid }" onclick="" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					
					<a title="删除" href="javascript:;" onclick="deleteSource(${ann.annid })" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			</c:forEach>
...
function deleteSource(annid){
	var flag = window.confirm("您确定要删除该公告吗");
	if(flag){
		location.href="servlet/AnnouncementServlet?method=deleteAnn&annid="+annid;
	}
}
</script> 
</body>
