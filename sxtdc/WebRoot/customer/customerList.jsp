			...
			<c:forEach items="${cusList }" var="cus">
				<tr class="text-c">
					...
					<td class="td-manage">
						...
						<a title="编辑" href="servlet/CustomerServlet?method=toUpdateCus&cusid=${cus.cusid}"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> &nbsp;			
						<a title="删除" href="javascript:;" onclick="deleteCus('${cus.cusid}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>&nbsp;&nbsp;
						<span class="label label-success radius">
							<a title="分配" href="servlet/CustomerServlet?method=toAllotCus&cusid=${cus.cusid}" class="ml-5" style="text-decoration:none">分配</a> 							
						</span>
					</td>
				</tr>
			</c:forEach>	
